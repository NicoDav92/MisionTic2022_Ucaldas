...
public class Principal1 extends javax.swing.JFrame {
    ...
    public Principal1() {
        initComponents();
        setLocationRelativeTo(null);//Centra la vista en la pantalla.
        listar();
    }
    ...
    private void TablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDatosMouseClicked
        int fila = TablaDatos.getSelectedRow();//Seleccionamos la fila donde queremos modificar.
        if(fila==-1){
            JOptionPane.showMessageDialog(null, "Usuario no seleccionado");
       }else{
            id=Integer.parseInt((String)TablaDatos.getValueAt(fila,0).toString());//fila columna 0.
            String dni=(String)TablaDatos.getValueAt(fila, 1);//fila columan 1.
            String nom=(String)TablaDatos.getValueAt(fila, 2);//fil columna 2.
            txtId.setText(""+id);//coloca los valores extraidos en cada caja respectivamente.
            txtDni.setText(dni);
    ...
    void modificar(){
    //Antes recibimos los valores que vamos a editar. en: nom y dni
    ...
    void nuevo(){
        ...
        txtDni.setText("");
        txtNombre.setText("");
        txtDni.requestFocus();//El puntero de mouse va directamente a la caja del DNI.
    }
